...
proc MatrixMultiply
	...
	mov dx, m1
	mul dx
	shl ax, 1		;изза того что размер строки dw
	mov n, ax
	add di, ax		;перескакиваем на 2 матрицу
	mov si, di
	sub di, ax		;по итогу в di хранится 1 матрица
...
mov ax, @DATA 			; настроим DS
	...
	call ErrorProc		;проверка на возможность перемножения матриц
	cmp ax, 1000
	je exitProgram
