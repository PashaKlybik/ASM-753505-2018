...
int WINAPI WinMain (HINSTANCE hThisInstance,
                     ...
                     LPSTR lpszArgument,
                     int nCmdShow) // Задаём окну параметры
{
...
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
        case WM_CREATE: //
            button = CreateWindow("button", "Clear",
...
bool LoadAndBlitBitmap(LPCSTR path, HDC hWinDC, int x, int y) //функция для отображения картинки задавая координаты(Спиздил с нета)
{
    HBITMAP hOldBmp;
	HBITMAP hBitmap;
	BITMAP bitmap;
