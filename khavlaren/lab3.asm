...
Start_Input:
	...
	MOV SI, 0						; Обнулить SI. Регистр отвечает за хранение.
	MOV AH, 01h
	INT 21h
...
Escape:
	...
	XOR SI, SI
	MOV CX, 7				; 7 раз стереть символ. Больше не понадобится, так как ввод не позволит этого сделать (max 5 знаков в числе + минус).
Back_Loop:
