...
;Варианты заданий:
;10) В резиденте находится строка A. Перекрыть девятую функцию прерывания 21h таким образом, чтобы вместо выводимой строки B выводилась наибольшая общая подпоследовательность строк A и B.
