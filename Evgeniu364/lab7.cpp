    ...
    case WM_PAINT:
        {
			...
			for (int i = 0; i < points.size(); i++)
			{
				...
				Ellipse(hdc, x - 63, y + 40, x + 33, y - 25);			
				Ellipse(hdc, x - 93, y - 40, x - 53, y);
				Ellipse(hdc, x - 93, y + 15, x - 53, y + 55);
				hRedBrush = CreateSolidBrush(RGB(0,0,0));
				hOldBrush = (HBRUSH)SelectObject(hdc, hRedBrush);
